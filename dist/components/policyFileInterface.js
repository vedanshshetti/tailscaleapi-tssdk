 ...
 */
const createPolicyFileInterface = (apiKey, tailnet) => {
    return {
        /**
         ...
         */
        getPolicyFile: () => createRetriever(apiKey, tailnet),
        /**
         ...
         * @throws {Error} If the API request fails
         */
        setPolicyFile: (body) => createPolicyFileSetter(apiKey, tailnet, body),
        /**
         ...
         * @throws {Error} If the API request fails
         */
        previewRuleMatches: (body, type, previewFor) => createPreviewRuleMatches(apiKey, tailnet, body, `?type=${type}&previewFor=${previewFor}`),
        /**
         ...
         * @throws {Error} If the API request fails
         */
        validateAndTestPolicyFile: (body) => createPolicyFileValAndTest(apiKey, tailnet, body)
    };
};
export default createPolicyFileInterface;
//# sourceMappingURL=policyFileInterface.js.map