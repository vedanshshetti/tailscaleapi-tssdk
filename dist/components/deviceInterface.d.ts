 ...
 */
declare const createDevicesInterface: (apiKey: APIKey, deviceID: string) => {
    /**
     ...
     */
    listTailnetDevices: (tailnet: string) => Promise<ListTailnetDevicesReturnType>;
    /**
     ...
     * @throws {Error} If the API request fails
     */
    batchUpdateCustomDevicePostureAttributes: (body: UpdateCustomDevicePostureAttributesBody) => Promise<void>;
    /**
     ...
     * @throws {Error} If the API request fails
     */
    setDeviceRoutes: (body: SetDeviceRoutesBody) => Promise<SetDeviceRoutesReturnType>;
    /**
     ...
     * @throws {Error} If the API request fails
     */
    getDevicePostureAttributes: () => Promise<GetDevicePostureAttributesReturnType>;
    /**
     ...
     * @throws {Error} If the API request fails
     */
    setCustomDevicePostureAttributes: (attribute: SetCustomDevicePostureAttributesBody) => Promise<GetDevicePostureAttributesReturnType>;
    /**
