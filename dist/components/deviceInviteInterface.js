 ...
 */
const createDeviceInvitesInterface = (apiKey, deviceID) => ({
    /**
     ...
     */
    createDeviceInvite: (body) => createDeviceInviteCreator(apiKey, deviceID, body),
    /**
     ...
     */
    getDeviceInvite: (inviteID) => createDeviceInviteRetriever(apiKey, inviteID),
    /**
     ...
     */
    deleteDeviceInvite: (inviteID) => createDeviceInviteDeleter(apiKey, inviteID),
    /**
     ...
     */
    resendDeviceInvite: (inviteID) => createDeviceInviteResender(apiKey, inviteID),
    /**
     ...
     */
    acceptDeviceInvite: (inviteID) => createDeviceInviteAcceptor(apiKey, inviteID)
});
export default createDeviceInvitesInterface;
//# sourceMappingURL=deviceInviteInterface.js.map