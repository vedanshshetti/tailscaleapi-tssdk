 ...
 * ```
 */
const TailscaleInterface = (apiKey) => {
    return {
        /**
         ...
         */
        devices: (deviceID) => createDevicesInterface(apiKey, deviceID),
        /**
         ...
         */
        policyFile: (tailnet) => createPolicyFileInterface(apiKey, tailnet),
        /**
         ...
         */
        keys: (tailnet) => createKeysInterface(apiKey, tailnet),
        /**
         ...
         */
        dns: (tailnet) => createDNSInterface(apiKey, tailnet),
        /**
         ...
         */
        users: (tailnet) => createUsersInterface(apiKey, tailnet),
        /**
         ...
         */
        userInvites: (tailnet) => createUserInvitesInterface(apiKey, tailnet),
        /**
         ...
         */
        deviceInvites: (deviceID) => createDeviceInvitesInterface(apiKey, deviceID),
        /**
         ...
         */
        posture: (tailnet) => createPostureInterface(apiKey, tailnet),
        /**
         ...
         */
        tailnetSettings: (tailnet) => createTailnetSettingsInterface(apiKey, tailnet),
        /**
         ...
         */
        organizations: (organization) => createOrganizationsInterface(apiKey, organization),
        /**
         ...
         */
        logging: (tailnet) => createLoggingInterface(apiKey, tailnet),
        /**
         ...
         */
        awsExternalID: (tailnet) => createAWSExternalIDInterface(apiKey, tailnet)
    };
};
